...
### Purpose
Creates a new Node.js RESTful API project with REST-Base standards pre-applied, including directory structure, configuration files, and boilerplate code.
...
### Purpose
Applies REST-Base standards to an existing Node.js project by copying documentation, configuration files, and setting up development dependencies.
...
This documentation provides complete reference for using and understanding the REST-SPEC CLI tools. For additional support, refer to the project's README.md and standards documentation in the `docs/standards/` directory.