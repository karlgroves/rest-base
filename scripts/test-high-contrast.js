...
async function testColorOutput() {
  ...
  const boxContent = 'This content is displayed\ninside a formatted box\nfor emphasis';
...
async function main() {
  ...
  switch (command) {
    ...
    default:
      await testColorOutput();
      console.log('\nUsage:');
      console.log('  node test-high-contrast.js              # Test with current settings');
      console.log('  node test-high-contrast.js compare      # Compare all themes');
      console.log('  node test-high-contrast.js high-contrast # Force high contrast mode');
      console.log('  node test-high-contrast.js no-color     # Force no color mode');
