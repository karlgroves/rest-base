...
class UpdateChecker {
  ...
  formatUpdateMessage(currentVersion, latestVersion) {
    return [
      ...
      "┌─────────────────────────────────────────────────────┐",
      "│                                                     │",
      "│          Update available for REST-SPEC            │",
      "│                                                     │",
      `│   Current: ${currentVersion.padEnd(10)} → Latest: ${latestVersion.padEnd(10)}   │`,
      "│                                                     │",
      "│   Run: npm install -g rest-spec@latest             │",
      "│   Or:  npm update -g rest-spec                     │",
      "│                                                     │",
      "│   Changelog: https://github.com/karlgroves/        │",
      "│             rest-spec/releases                      │",
      "│                                                     │",
      "└─────────────────────────────────────────────────────┘",
      "",
